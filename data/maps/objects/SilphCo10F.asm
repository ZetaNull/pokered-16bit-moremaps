...
SilphCo10F_Object:
	...
	def_object_events
	object_event  1,  9, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO10F_ROCKET, ROCKET, 39
	object_event 10,  2, SPRITE_SCIENTIST, STAY, LEFT, TEXT_SILPHCO10F_SCIENTIST, SCIENTIST, 11
