...
PokemonTower6F_Object:
	...
	def_object_events
	object_event 12, 10, SPRITE_CHANNELER, STAY, RIGHT, TEXT_POKEMONTOWER6F_CHANNELER1, CHANNELER, 19
	object_event  9,  5, SPRITE_CHANNELER, STAY, DOWN, TEXT_POKEMONTOWER6F_CHANNELER2, CHANNELER, 20
	object_event 16,  5, SPRITE_CHANNELER, STAY, LEFT, TEXT_POKEMONTOWER6F_CHANNELER3, CHANNELER, 21
