...
SilphCo6F_Object:
	...
	object_event 17,  3, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO6F_ROCKET1, ROCKET, 30
	object_event  7,  8, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO6F_SCIENTIST, SCIENTIST, 7
	object_event 14, 15, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO6F_ROCKET2, ROCKET, 31
