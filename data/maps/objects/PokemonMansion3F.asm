...
PokemonMansion3F_Object:
	...
	def_object_events
	object_event  5, 11, SPRITE_SUPER_NERD, WALK, LEFT_RIGHT, TEXT_POKEMONMANSION3F_SUPER_NERD, BURGLAR, 8
	object_event 20, 11, SPRITE_SCIENTIST, STAY, LEFT, TEXT_POKEMONMANSION3F_SCIENTIST, SCIENTIST, 12
