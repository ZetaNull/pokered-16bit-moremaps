...
SilphCo3F_Object:
	...
	object_event 20,  7, SPRITE_ROCKET, STAY, LEFT, TEXT_SILPHCO3F_ROCKET, ROCKET, 25
	object_event  7,  9, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO3F_SCIENTIST, SCIENTIST, 4
