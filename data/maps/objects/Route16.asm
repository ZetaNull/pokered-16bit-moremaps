...
Route16_Object:
	...
	def_object_events
	object_event 17, 12, SPRITE_BIKER, STAY, LEFT, TEXT_ROUTE16_BIKER1, BIKER, 5
	object_event 14, 13, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE16_BIKER2, CUE_BALL, 1
	object_event 11, 12, SPRITE_BIKER, STAY, UP, TEXT_ROUTE16_BIKER3, CUE_BALL, 2
	object_event  9, 11, SPRITE_BIKER, STAY, LEFT, TEXT_ROUTE16_BIKER4, BIKER, 6
	object_event  6, 10, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE16_BIKER5, CUE_BALL, 3
	object_event  3, 12, SPRITE_BIKER, STAY, RIGHT, TEXT_ROUTE16_BIKER6, BIKER, 7
