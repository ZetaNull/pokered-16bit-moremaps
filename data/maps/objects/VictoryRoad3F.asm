...
VictoryRoad3F_Object:
	...
	def_object_events
	object_event 28,  5, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_VICTORYROAD3F_COOLTRAINER_M1, COOLTRAINER_M, 2
	object_event  7, 13, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_VICTORYROAD3F_COOLTRAINER_F1, COOLTRAINER_F, 2
	object_event  6, 14, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_VICTORYROAD3F_COOLTRAINER_M2, COOLTRAINER_M, 3
	object_event 13,  3, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_VICTORYROAD3F_COOLTRAINER_F2, COOLTRAINER_F, 3
