...
SilphCo9F_Object:
	...
	object_event  2,  4, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO9F_ROCKET1, ROCKET, 37
	object_event 21, 13, SPRITE_SCIENTIST, STAY, DOWN, TEXT_SILPHCO9F_SCIENTIST, SCIENTIST, 10
	object_event 13, 16, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO9F_ROCKET2, ROCKET, 38
