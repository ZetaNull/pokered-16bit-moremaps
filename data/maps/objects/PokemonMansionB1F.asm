...
PokemonMansionB1F_Object:
	...
	def_object_events
	object_event 16, 23, SPRITE_SUPER_NERD, STAY, NONE, TEXT_POKEMONMANSIONB1F_BURGLAR, BURGLAR, 9
	object_event 27, 11, SPRITE_SCIENTIST, STAY, DOWN, TEXT_POKEMONMANSIONB1F_SCIENTIST, SCIENTIST, 13
