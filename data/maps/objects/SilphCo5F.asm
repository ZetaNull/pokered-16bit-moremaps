...
SilphCo5F_Object:
	...
	object_event  8, 16, SPRITE_ROCKET, STAY, RIGHT, TEXT_SILPHCO5F_ROCKET1, ROCKET, 28
	object_event  8,  3, SPRITE_SCIENTIST, STAY, RIGHT, TEXT_SILPHCO5F_SCIENTIST, SCIENTIST, 6
	object_event 18, 10, SPRITE_ROCKER, STAY, UP, TEXT_SILPHCO5F_ROCKER, JUGGLER, 1
	object_event 28,  4, SPRITE_ROCKET, STAY, UP, TEXT_SILPHCO5F_ROCKET2, ROCKET, 29
