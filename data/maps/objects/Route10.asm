...
Route10_Object:
	...
	def_object_events
	object_event 10, 44, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_ROUTE10_SUPER_NERD1, POKEMANIAC, 1
	object_event  3, 57, SPRITE_HIKER, STAY, UP, TEXT_ROUTE10_HIKER1, HIKER, 7
	object_event 14, 64, SPRITE_SUPER_NERD, STAY, LEFT, TEXT_ROUTE10_SUPER_NERD2, POKEMANIAC, 2
	object_event  7, 25, SPRITE_COOLTRAINER_F, STAY, LEFT, TEXT_ROUTE10_COOLTRAINER_F1, JR_TRAINER_F, 7
	object_event  3, 61, SPRITE_HIKER, STAY, DOWN, TEXT_ROUTE10_HIKER2, HIKER, 8
	object_event  7, 54, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_ROUTE10_COOLTRAINER_F2, JR_TRAINER_F, 8
