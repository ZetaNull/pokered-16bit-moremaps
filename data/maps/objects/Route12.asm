...
Route12_Object:
	...
	object_event 14, 31, SPRITE_FISHER, STAY, LEFT, TEXT_ROUTE12_FISHER1, FISHER, 3
	object_event  5, 39, SPRITE_FISHER, STAY, UP, TEXT_ROUTE12_FISHER2, FISHER, 4
	object_event 11, 92, SPRITE_COOLTRAINER_M, STAY, LEFT, TEXT_ROUTE12_COOLTRAINER_M, JR_TRAINER_M, 9
	object_event 14, 76, SPRITE_SUPER_NERD, STAY, UP, TEXT_ROUTE12_SUPER_NERD, ROCKER, 2
	object_event 12, 40, SPRITE_FISHER, STAY, LEFT, TEXT_ROUTE12_FISHER3, FISHER, 5
	object_event  9, 52, SPRITE_FISHER, STAY, RIGHT, TEXT_ROUTE12_FISHER4, FISHER, 6
	object_event  6, 87, SPRITE_FISHER, STAY, DOWN, TEXT_ROUTE12_FISHER5, FISHER, 11
